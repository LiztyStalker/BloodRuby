...
/// 공격속도 값 변동
/// </summary>
public class AttackSpeedAddStateClass : ValueAddStateClass
{
//    public override float valueCalculator(float value)
//    {
//		float cal_value = value * 1f / this.percent - this.value;
//		if (cal_value <= 0f)
//			return 0f;
//		return cal_value;
//    }

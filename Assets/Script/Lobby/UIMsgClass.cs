...
public class UIMsgClass : UILobbyParentClass, IPointerClickHandler
{
...
//		effectSoundPlayer(TYPE_AUDIO.CANCEL);
	...
	void closeBtnEvent(bool isSound = false){
		
		transform.parent.GetComponent<UILobbyClass> ().PopPanelClicked ();
